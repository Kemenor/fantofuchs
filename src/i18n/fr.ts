...
export const fr: Catalogue = {
  ...
  plan: {
    ...
    fitsHere: (n) => (n === 1 ? '1 film tient ici' : `${n} films tiennent ici`),
    addFiller: 'Ajouter',
    addFillerLabel: (title) => `Ajouter ${title} à la liste`,
    alsoAt: 'Passe aussi',
    alsoAtLabel: (title) => `Autres séances de ${title} qui conviendraient encore`,
    noAlternatives: 'seule séance qui convienne',
    print: 'Imprimer',
