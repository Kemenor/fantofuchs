...
const en = {
  ...
  plan: {
    ...
    fitsHere: (n: number) => (n === 1 ? '1 film fits here' : `${n} films fit here`),
    addFiller: 'Add',
    addFillerLabel: (title: string) => `Add ${title} to the wishlist`,
    alsoAt: 'Also screens',
    alsoAtLabel: (title: string) => `Other screenings of ${title} that would still fit`,
    noAlternatives: 'only screening that fits',
    print: 'Print',
